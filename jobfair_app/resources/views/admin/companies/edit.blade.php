...
<body class="bg-gray-900 text-white">
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            <h2 class="text-3xl font-bold mb-8">Ubah Data Perusahaan</h2>
            <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
                <form action="{{ route('admin.companies.update', $company) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="w-full px-3 py-2 bg-gray-700 rounded @error('name') border border-red-500 @enderror" value="{{ old('name', $company->name) }}" required>
                        @error('name')
