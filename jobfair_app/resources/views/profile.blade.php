...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h3 class="card-title mb-0">Profil Pelamar</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-4 text-center">
                ...
                <a href="{{ asset('storage/' . $applicant->cv_path) }}" class="btn btn-primary w-100" target="_blank">Unduh CV (PDF)</a>
            </div>
            <div class="col-md-8">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><strong>Portfolio:</strong> <a href="{{ $applicant->portfolio_link }}" target="_blank">{{ $applicant->portfolio_link }}</a></li>
                    @endif
                </ul>
            </div>
        </div>
